...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ScheduleRating", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("ScheduleRating", (string)null);
                });
            ...
            modelBuilder.Entity("WebApplication1.Data.Instruction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("MovingScheduleId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("MovingScheduleId");

                    b.HasIndex("StayingScheduleId");
            ...
            modelBuilder.Entity("WebApplication1.Data.Receipt.FullReceipt", b =>
                {
                    b.Property<int>("FullReceiptId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("FullReceiptId"));
                    ...
                    b.Property<Guid?>("TourishScheduleId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebApplication1.Data.Receipt.TotalScheduleReceipt", b =>
                {
                    ...
                    b.HasIndex("MovingScheduleId")
                        .IsUnique()
                        .HasFilter("[MovingScheduleId] IS NOT NULL");
            ...
            modelBuilder.Entity("WebApplication1.Data.ScheduleInterest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ScheduleInterest", (string)null);
                });

            modelBuilder.Entity("WebApplication1.Data.ServiceComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebApplication1.Data.TourishSchedule", b =>
                {
                    ...
                    b.ToTable("TourishSchedule", (string)null);
                });
            ...
            modelBuilder.Entity("WebApplication1.Data.ServiceComment", b =>
                {
                    b.HasOne("WebApplication1.Data.Schedule.MovingSchedule", "MovingSchedule")
                        .WithMany("ServiceCommentList")
                        .HasForeignKey("MovingScheduleId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("FK_MovingSchedule_ServiceComment");

                    b.HasOne("WebApplication1.Data.Schedule.StayingSchedule", "StayingSchedule")
                        .WithMany("ServiceCommentList")
                        .HasForeignKey("StayingScheduleId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("FK_StayingSchedule_ServiceComment");
                    ...
                    b.HasOne("WebApplication1.Data.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_User_ServiceComment");
            ...
            modelBuilder.Entity("WebApplication1.Data.Schedule.MovingSchedule", b =>
                {
                    ...
                    b.Navigation("ScheduleInterestList");

                    b.Navigation("ServiceCommentList");
            ...
            modelBuilder.Entity("WebApplication1.Data.TourishPlan", b =>
                {
                    ...
                    b.Navigation("TourishScheduleList");
                });
            ...
            modelBuilder.Entity("WebApplication1.Data.User", b =>
                {
                    ...
                    b.Navigation("ScheduleRatingList");
